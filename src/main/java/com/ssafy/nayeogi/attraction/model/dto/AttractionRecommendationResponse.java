...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "관광지 추천 응답")
public class AttractionRecommendationResponse {

    @Schema(description = "추천 결과 ID", example = "12540")
    private Integer id;

    @Schema(description = "콘텐츠 ID", example = "3145112")
    ...
    @Schema(description = "추천 점수", example = "0.23")
    private Double cal_score;
}
